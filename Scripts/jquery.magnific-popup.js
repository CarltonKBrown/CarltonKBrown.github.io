    ...
    w.prototype = {
            ...
            _close: function() {
                ...
                o.off("keyup" + h + " focusin" + h),
                    ...
                    t.container.attr("class", "mfp-container"), !t.st.showCloseBtn || t.st.closeBtnInside && t.currTemplate[t.currItem.type] !== !0 || t.currTemplate.closeBtn && t.currTemplate.closeBtn.detach(),
